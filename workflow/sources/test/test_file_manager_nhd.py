...
#bounds4_crs = np.array(list(workflow.warp.warp_xy(bounds4[0], bounds4[1], workflow.crs.latlon_crs(), workflow.crs.default_crs())) + list(workflow.warp.warp_xy(bounds4[2], bounds4[3], workflow.crs.latlon_crs(), workflow.crs.default_crs())))

#bounds8_crs = np.array(list(workflow.warp.warp_xy(bounds8[0], bounds8[1], workflow.crs.latlon_crs(), workflow.crs.default_crs())) + list(workflow.warp.warp_xy(bounds8[2], bounds8[3], workflow.crs.latlon_crs(), workflow.crs.default_crs())))
