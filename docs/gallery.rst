...
.. code-block:: console
   ...
   python bin/plot_hucs.py --source-huc=NHD --source-hydro=NHD --output-filename=docs/static/gallery_sources_nhd.png 060102020103

.. image:: static/gallery_sources_nhd.png
