...
python environments/create_envs.py --manager=mamba --env-type=CI --env-name=${CI_ENV_NAME} OSX
...
python environments/create_envs.py --manager=mamba --env-type=DEV --env-name=${DEV_ENV_NAME} OSX
