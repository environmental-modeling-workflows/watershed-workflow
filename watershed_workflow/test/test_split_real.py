...
def test_split_real(sources):
    huc = sources['HUC']
    profile,h8s1 = watershed_workflow.get_hucs(huc, '060101', 8, out_crs=watershed_workflow.crs.default_crs())
    profile,h8s2 = watershed_workflow.get_hucs(huc, '060102', 8, out_crs=watershed_workflow.crs.default_crs())
