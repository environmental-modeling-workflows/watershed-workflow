...
import watershed_workflow.hydrography_old as hydro
...
def test_snap0():
    ...
    rivers = hydro.snap(hucs, rivers1, 0.1, cut_intersections=True)
    check1(hucs, rivers)
...
def test_snap0a():
    ...
    rivers = hydro.snap(hucs, rivers, 0.1, cut_intersections=True)
    check1(hucs, rivers)
