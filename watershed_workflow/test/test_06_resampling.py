...
def test_uniform_smaller():
    ...
    assert watershed_workflow.utils.utils.isClose(ls_out, ls_test, 1.e-10)
...
def test_nonuniform_smaller():
    ...
    assert watershed_workflow.utils.utils.isClose(ls_out, ls_test, 1.e-6)
...
def test_nonuniform_no_keep_corner():
    ...
    print(ss[1:] - ss[:-1])
    assert watershed_workflow.utils.utils.isClose(ls_out.coords[0], ls_in.coords[0])
    assert watershed_workflow.utils.utils.isClose(ls_out.coords[-1], ls_in.coords[-1])
