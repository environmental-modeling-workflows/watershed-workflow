...
def createNLCDColormap(indices=None, formatted=False):
    import watershed_workflow.sources.manager_nlcd
    return _createColormapCreator('NLCD', watershed_workflow.sources.manager_nlcd.colors)(indices, formatted)
