...
def test_nhdplus2(nhd):
    ...
    bounds = watershed_workflow.utils.create_shply(hucs[0]['geometry']).bounds
...
def test_vaa(nhd):
    profile, reaches = nhd.get_hydro('060102020103',
                                     properties=[
                                         'HydrologicSequence', 'DownstreamMainPathHydroSeq',
                                         'TotalDrainageAreaSqKm', 'CatchmentAreaSqKm'
                                     ])
