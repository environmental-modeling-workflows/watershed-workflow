...
def _getDefaultConfig() -> configparser.ConfigParser:
...
#: Global configuration, populated at import time from environment
#: variables and ``.watershed_workflowrc`` files.  Read directly (e.g.
#: ``watershed_workflow.utils.rcParams['DEFAULT']['data_directory']``)
