...
__all__ = [
    ...
    'isVolumetricIntersection',
    'filterToShape',
    'isEmpty',
    'isConvex',
    'breakLineStringCollinearity',
    'reverseLineString',
    'isClose',
    'contains',
    'cut',
    'inNeighborhood',
    'intersectPointToSegment',
    'findNearestPoint',
    'removeThirdDimension',
    'computeSegmentLengths',
    'computeArclengths',
    'logMinMaxMedianSegment',
    'generateRings',
    'generateCoords',
]
...
def filterToShape(df: gpd.GeoDataFrame,
    ...
    """
    if shape_crs != df.crs:
        shape = watershed_workflow.utils.warp.warpShply(shape, shape_crs, df.crs)
