...
def setupLogging(verbosity, logfile=None):
...
def projection(parser):
    ...
    parser.add_argument('--projection',
                        type=valid_epsg,
                        default=watershed_workflow.crs.default_crs(),
...
def getSources(args) -> Dict[str, Any]:
    ...
    """
    result = watershed_workflow.sources.getDefaultSources()
    ...
    for arg_name, (role, category) in _arg_map.items():
        try:
            ...
            continue
        result[role] = watershed_workflow.sources.sources[category][key]
